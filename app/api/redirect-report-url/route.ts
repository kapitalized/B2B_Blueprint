 ...
 * GET ?projectId=uuid&reportId=uuid → { url: "/project/shortId/slug/reports/reportShortId" } or 404.
 */
...
export async function GET(req: Request) {
  ...
  const url = `/project/${project.shortId}/${project.slug}/reports/${report.shortId}`;
